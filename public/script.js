...
//  code comments generated by AI

// // Unique server = https://jsonserverbpmbea-kezm-yuhqp7wc--3000--c4712070.local-credentialless.webcontainer.io/api/v1/courses
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const myApiUrl = 'https://jsonserverbpmbea-kezm-yuhqp7wc--3000--c4712070.local-credentialless.webcontainer.io/api/v1/courses'
...
function sendLogsRequest(inputValue) {
  ...
  const forLogs = `https://jsonserverbpmbea-kezm-yuhqp7wc--3000--c4712070.local-credentialless.webcontainer.io/api/v1/logs?courseId=${courseId}&uvuId=${inputValue}`
...
addLogButton.addEventListener('click', function(event) {
  ...
  if (courseId && uvuId.length === 8 && logValue) {
    const postUrl = `https://jsonserverbpmbea-kezm-yuhqp7wc--3000--c4712070.local-credentialless.webcontainer.io/api/v1/logs`
